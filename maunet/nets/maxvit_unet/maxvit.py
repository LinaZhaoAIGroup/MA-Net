...
class MBConv(nn.Module):
    ...
    def __init__(
        ...
        self.skip_path = nn.Sequential(
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)) if downscale else nn.Identity(),
            nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=(1, 1)) if in_channels != out_channels else nn.Identity()
        ) 
